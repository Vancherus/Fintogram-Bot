...
CHAIN_DESCRIPTIONS = {
    ...
    '🧊 BITкурий': '🧊 BITкурий — холодный, быстрый и старый потомок Великого Первоблокa. Выбирают те, кто ценит надёжность биткоина, но не готов ждать эпоху подтверждений. Разработан криптоэнтузиастом <i>Делюкши Финтопиото</i>.',
